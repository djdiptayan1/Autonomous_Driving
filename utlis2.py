...
def warpImg1(img, points, w, h, inv=False):
...
def initializeTrackbars(intialTracbarVals, wT=854, hT=480):
    cv2.namedWindow("Trackbars")
    cv2.resizeWindow("Trackbars", 854, 480)
...
def valTrackbars(wT=854, hT=854):
